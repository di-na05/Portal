...
export default function Page() {
  ...
  // other hooks must always execute regardless of `hasConfirmedWeek`
  ...
  setSelections((prev) => {
    ...
    slots.forEach((slot) => {
      ...
      // If checked, set to Executive; if unchecked, set to empty (None)
      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white shadow-lg">
        <div className="flex justify-between items-center px-4 py-6">
          <div>
            ...
            <p className="text-blue-100 mt-1">Manage schedule and assignments</p>
          </div>
                ...
                {getTimeSlotsForDay(day)
                  ...
                  .map((slot) => (
                    ...
                    {COLUMNS.map((col) => {
                      ...
                      // Admin slots are locked as Executive by design
